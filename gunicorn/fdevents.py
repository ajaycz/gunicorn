...
""" module implementing Pollster depending on the platform. A pollster
...
if hasattr(select, "poll") or hasattr(select, "epoll"):
    ...
    if hasattr(select, "devpoll"):
        ...
        class DevPollPollster(_PollerBase):
            POLL_IMPL = select.devpoll

    if hasattr(select, "poll"):
        class PollPollster(_PollerBase):
            POLL_IMPL = select.poll


# choose the best implementation depending on the platform.
if 'KqueuePollster' in globals():
    DefaultPollster = KqueuePollster
elif 'EpollSelector' in globals():
    DefaultPollster = EpollPollster
elif 'DevpollSelector' in globals():
    DefaultPollster = DevpollPollster
elif 'PollSelector' in globals():
    DefaultPollster = PollPollster
else:
    DefaultPollster = SelectPollster
